        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a href="#" className="hover:text-vaal-orange-400 transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link to="/submit-news" className="hover:text-vaal-orange-400 transition-colors">Submit News</Link></li>
